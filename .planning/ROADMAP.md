...
- [ ] **Phase 1: Foundation & Auth** — Next.js project, Firebase integration, auth, data model, base layout
...
Plans:
- [ ] 02-01: Level roadmap UI and lesson page structure (MDX theory rendering, exercise lists, checklists)
